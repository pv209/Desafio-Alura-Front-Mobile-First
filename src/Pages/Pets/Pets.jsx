      ...
      <div className="main__pets">
        ...
        <div className="main__cards">
          <Card
            ...
            name="Dunga"
            age="2 anos"
            Desc="Porte pequeno  Calmo e educado"
          ...
          <Card
            ...
            name="Felícia"
            age="3 meses"
            Desc="Porte pequeno  Ativa e carinhosa"
          ...
          <Card
            ...
            name="Sirius"
            age="6 meses"
            Desc="Porte grande  Ativo e educado"
          ...
          <Card
            ...
            name="Fiona"
            age="3 anos"
            Desc="Porte pequeno  Calma e carinhosa"
          ...
          <Card
            ...
            name="Sid"
            age="8 meses"
            Desc="Porte médio/grande Brincalhão e amável"
            local="Rio de Janeiro (RJ)"
          />
          <Card
            pet={yoda}
            name="Yoda"
            age="1 ano"
            Desc="Porte médio Ativo e carinhoso"
            local="Nova Iguaçu (RJ)"
          />
          <Card
            pet={lua}
            name="Lua"
            age="6 meses"
            Desc="Porte médio Ativa e carinhosa"
            local="Duque de Caxias (RJ)"
          />
          <Card
            pet={amora}
            name="Amora"
            age="45 dias"
            Desc=" Porte grande Calma e carinhosa"
            local="São Gonçalo (RJ)"
          />
          <Card
            pet={zelda}
            name="Zelda"
            age="5 meses"
            Desc="Porte médio Ativa e amável"
            local="Rio de Janeiro (RJ)"
          />
        </div>
